...
3. Run (fill in variables): MYSQL_HOST=127.0.0.1 MYSQL_USER=root MYSQL_PASSWORD= MYSQL_DB=mysql NEW_RELIC_STARTUP_DEBUG=true NEW_RELIC_CONFIG_FILE=$(pwd)/newrelic.ini  NEW_RELIC_LICENSE_KEY=*** NEW_RELIC_APP_NAME="Newrelic Test" newrelic-admin run-program gunicorn -w 4 myapp:app --bind 0.0.0.0:8000 --access-logfile=-
